...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://www.cnet.com/es/noticias/").then(function(response) {
    ...
    $(".riverPost").each(function(i, element) {
      ...
      var result = {};
      const $text = $(this).find('.assetText');
      var $img = $(this).find('.assetThumb')
      $img =$img.find('span');
      
      result.title=$text.find('h3 a').text();
